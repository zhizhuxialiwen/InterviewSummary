...
```c++
wen@wen-virtual-machine:~/gopath/src/IO/selectpollepoll$ g++ -o select_server tcpselect.cpp 
wen@wen-virtual-machine:~/gopath/src/IO/selectpollepoll$ ./select_server  5005
```
//select client
![select4](../../images/select4.PNG)
```c++
wen@wen-virtual-machine:~/gopath/src/IO/selectpollepoll$ g++ -o client  client.cpp       
wen@wen-virtual-machine:~/gopath/src/IO/selectpollepoll$ ./client  127.0.0.1 5005
```
