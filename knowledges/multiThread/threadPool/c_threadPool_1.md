...
手把手教你撸一个线程池 - C 语言版，这里把相关的代码贴出来，以供参考。
...
c/threadPool/threadPool_1$ `gcc -o out threadPool_1.c threadPoolMain.c  -lpthread`
c/threadPool/threadPool_1$ `./out `
